...
def erm(symbol, stock_price, balance_sheet, income_stmt, xlsx, dfs, COST_OF_EQUITY, STABLE_ROE, HIGH_GROWTH_PERIOD, STABLE_GROWTH_PERIOD, NUMBER_OF_YEARS, exchange_ticker, filepath, stock, STABLE_GROWTH_RATE):
        roe = None
        try:
