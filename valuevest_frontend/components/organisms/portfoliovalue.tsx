        ...
        <View>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View style={{ marginLeft: 5 }}>
              <Text
                style={[
                  parseFloat(portfolio.dailyPnL.toFixed(2)) === 0
                    ? containerStyle.containerTextBlack
                    : parseFloat(portfolio.dailyPnL.toFixed(2)) < 0
                    ? containerStyle.containerTextRed
                    : containerStyle.containerTextGreen
                ]}
              >
                {parseFloat(portfolio.dailyPnL.toFixed(2)) === 0
                  ? `$${Math.abs(parseFloat(portfolio.dailyPnL.toFixed(2)))}`
                  : parseFloat(portfolio.dailyPnL.toFixed(2)) < 0
                  ? `-$${Math.abs(parseFloat(portfolio.dailyPnL.toFixed(2)))}`
                  : `+$${parseFloat(portfolio.dailyPnL.toFixed(2))}`}
              </Text>
            </View>
          </View>
          ...
          {showAll && (
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View style={{ marginLeft: 5 }}>
                <Text
                  style={[
                    parseFloat(portfolio.overallPerformance.toFixed(2)) === 0
                      ? containerStyle.containerTextBlack
                      : parseFloat(portfolio.overallPerformance.toFixed(2)) < 0
                      ? containerStyle.containerTextRed
                      : containerStyle.containerTextGreen
                ...
                >
                  {parseFloat(portfolio.overallPerformance.toFixed(2)) === 0
                    ? `$${Math.abs(parseFloat(portfolio.overallPerformance.toFixed(2)))}`
                    : parseFloat(portfolio.overallPerformance.toFixed(2)) < 0
                    ? `-$${Math.abs(parseFloat(portfolio.overallPerformance.toFixed(2)))}`
                    : `+$${parseFloat(portfolio.overallPerformance.toFixed(2))}`}
                </Text>
              </View>
            </View>
          )}
